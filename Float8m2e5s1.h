...
struct float8m2e5s1_t
{
    float8m2e5s1_t() = default;
    float8m2e5s1_t(const float8m2e5s1_t&) = default;
    float8m2e5s1_t(float8m2e5s1_t&&) = default;

    float8m2e5s1_t(float floatValue) noexcept
    {
        // TODO:
        value = ... floatValue ...;
    }

    float8m2e5s1_t& operator =(const float8m2e5s1_t&) = default;

    float8m2e5s1_t& operator =(float floatValue) noexcept
    {
        // TODO:
        value = ... floatValue ...;
        return *this;
